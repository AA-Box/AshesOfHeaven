...
void AHorrorCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
...

	{
		...
		if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
		{
			...
			UInputAction* EffectiveSprintAction = SprintAction ? SprintAction : (PlatformManager ? PlatformManager->GetSprintAction() : nullptr);

			// Sprinting
			if (EffectiveSprintAction)
			{
				EnhancedInputComponent->BindAction(EffectiveSprintAction, ETriggerEvent::Started, this, &AHorrorCharacter::DoStartSprint);
				EnhancedInputComponent->BindAction(EffectiveSprintAction, ETriggerEvent::Completed, this, &AHorrorCharacter::DoEndSprint);
			}
