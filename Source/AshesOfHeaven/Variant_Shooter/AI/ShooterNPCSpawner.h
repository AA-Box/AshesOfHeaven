 ...
 */
UCLASS()
class ASHESOFHEAVEN_API AShooterNPCSpawner : public AActor
{
	GENERATED_BODY()
...
protected:
	...
	/** Current tier-1 combatant registered against the shared platform budget. */
	UPROPERTY(Transient)
	TObjectPtr<AShooterNPC> ActiveNPC;

	bool bRegisteredActiveCombatant = false;
