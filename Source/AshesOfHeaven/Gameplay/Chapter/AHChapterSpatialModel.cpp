...
namespace
{
	...
	const TArray<FAHStageSpatialDefinition>& Definitions()
	{
		static const TArray<FAHStageSpatialDefinition> Values = {
			...
			Stage(EAHChapterStage::CathedralApproach, TEXT("CathedralApproach"), FVector(11100.0f, 0.0f, 50.0f), FVector(14500.0f, 0.0f, 790.0f), FVector(7900.0f, -1500.0f, -200.0f), FVector(15500.0f, 1500.0f, 1150.0f), -50.0f, TEXT("Cathedral"), TEXT("Ch01_ReachCathedralApproach"), TEXT("CathedralRamp"), FVector(14000.0f, 0.0f, 890.0f), TEXT("Ch01_Cathedral_Approach")),
			Stage(EAHChapterStage::FailsafeOrder, TEXT("CathedralInterior"), FVector(14100.0f, 0.0f, 890.0f), FVector(15100.0f, 0.0f, 790.0f), FVector(14000.0f, -900.0f, 650.0f), FVector(16500.0f, 900.0f, 1150.0f), 790.0f, TEXT("Cathedral"), TEXT("Ch01_ActivatePlanetaryFailsafe"), TEXT("EnterCathedral"), FVector(14700.0f, 0.0f, 890.0f), TEXT("Ch01_Cathedral_Approach")),
			...
			Stage(EAHChapterStage::SaelTransmission, TEXT("CathedralInterior"), FVector(17000.0f, 0.0f, 890.0f), FVector(17600.0f, 0.0f, 790.0f), FVector(15000.0f, -900.0f, 650.0f), FVector(19000.0f, 900.0f, 1150.0f), 790.0f, TEXT("Cathedral"), TEXT("Ch01_ReachTerminal"), TEXT("ReachTerminal"), FVector(18100.0f, 0.0f, 890.0f), TEXT("Ch01_Cathedral_Interior")),
	...
	const TArray<FAHCheckpointSpatialDefinition>& Checkpoints()
	{
		static const TArray<FAHCheckpointSpatialDefinition> Values = {
			...
			{FName(TEXT("Ch01_Cathedral_Approach")), EAHChapterStage::CathedralApproach, FName(TEXT("CathedralApproach")), FVector(11100.0f, 0.0f, 50.0f), FRotator::ZeroRotator},
